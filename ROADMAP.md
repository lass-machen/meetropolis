...
Projects board](https://github.com/tiamatlabs/meetropolis/projects).

If a feature you care about is not on this list, open a
[Discussion](https://github.com/tiamatlabs/meetropolis/discussions). We
read every one.
...
- Single-tenant deployment via `docker compose`, with a 25-user soft cap
  controlled by `OSS_USER_LIMIT`.
...
- **Custom open-licensed character sprites** to replace the current
  placeholder set (see [`docs/character-sprites-spec.md`](https://github.com/tiamatlabs/meetropolis/blob/main/docs/character-sprites-spec.md)
  in the deploy repo for the artist briefing).
...
- File a [feature request](https://github.com/tiamatlabs/meetropolis/issues/new?template=feature_request.yml).
- Comment on the [Discussions board](https://github.com/tiamatlabs/meetropolis/discussions).
