...
- **Dateigrößen (Quellcode)**
  ...
  - Phaser Scene-Dateien: Ziel ≤ 300 LoC, absolut ≤ 450 LoC.
...
Konkrete Maßnahme: `apps/web/src/App.tsx` (aktuell > 3.700 Zeilen) muss zeitnah in thematische Container zerlegt werden (z. B. `routing/`, `providers/`, `ui/layout/`, `features/*`). PRs, die die Datei weiter vergrößern, werden abgelehnt.
