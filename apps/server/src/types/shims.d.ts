...
// Optional proprietary telemetry module (Signalyr relay). Present only in
// enterprise builds. Callers narrow at the load site (see telemetryLoader.ts).
declare module '@meetropolis/telemetry-node' {
  const mod: unknown;
  export default mod;
}
