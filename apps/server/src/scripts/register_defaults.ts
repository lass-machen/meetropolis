...
async function main() {
  ...
  const defaults: Array<{ slot: number; key: string; imageUrl: string; tileWidth: number; tileHeight: number }> = [
    { slot: 0, key: 'office_floor', imageUrl: '/assets/tilesets/office_floor.png', tileWidth: 16, tileHeight: 16 },
    { slot: 1, key: 'office_wall', imageUrl: '/assets/tilesets/office_wall.png', tileWidth: 16, tileHeight: 32 },
    { slot: 2, key: 'collision', imageUrl: '/assets/tilesets/collision.png', tileWidth: 16, tileHeight: 16 },
  ];
