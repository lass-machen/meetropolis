  ...
  for (const p of packs || []) {
    ...
    for (const s of p.structures || []) {
      packItems.push({
        ...
        collisionBaseHeight: s.collisionBaseHeight ?? 0,
        renderLayer: s.renderLayer ?? 'sorted',
      });
    }
    for (const o of p.objects || []) {
      packItems.push({
        ...
        collisionBaseHeight: o.collisionBaseHeight ?? 0,
        renderLayer: o.renderLayer ?? 'sorted',
      });
    }
  }
...
function loadDefaultTilesets(setEditor: EditorSetter) {
  const defaultTs: Array<{
    ...
    {
      key: 'office_floor',
      dataUrl: '/assets/tilesets/office_floor.png',
      tileWidth: 16,
      tileHeight: 16,
      category: 'terrain',
    },
    {
      key: 'office_wall',
      dataUrl: '/assets/tilesets/office_wall.png',
      tileWidth: 16,
      tileHeight: 32,
      category: 'terrain',
    },
    {
      key: 'collision',
      dataUrl: '/assets/tilesets/collision.png',
      tileWidth: 16,
      tileHeight: 16,
      category: 'terrain',
    },
