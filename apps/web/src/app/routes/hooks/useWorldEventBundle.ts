...
import type { WorldRefs, WorldUi, WorldAuth } from './useWorldAppState';
...
export function useWorldEventBundle(params: {
  ...
  const { apiBase, refs, ui, auth, editor, applyVolumesToUi, saveAllToServer, handleConnectionReload, dismissBanner } =
    params;
  ...
  const eventHandlers = useWorldEventHandlers({
    ...
    setMe: auth.setMe,
    setGridExpanded: ui.setGridExpanded,
    setSelectedSid: ui.setSelectedSid,
    ...
    setRosterCollapsed: ui.setRosterCollapsed,
