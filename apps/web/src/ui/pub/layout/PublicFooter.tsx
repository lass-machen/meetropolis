...
function scrollToSectionFromFooter(anchorId: string) {
  ...
  // Otherwise navigate to landing page first, then scroll after a short delay.
...
export function PublicFooter({ navigate }: PublicFooterProps) {
  ...
  return (
    ...
    >
      <div
        style={{
          padding: 'var(--pub-footer-padding)',
      ...
      >
                    ...
                    return (
                      <li key={link.i18nKey}>
                        <a
                          ...
                          onMouseEnter={(e) => {
                            if (!isDisabled) {
                              e.currentTarget.style.color = 'var(--pub-text-on-dark)';
                            }
                          }}
                          onMouseLeave={(e) => {
                            if (!isDisabled) {
                              e.currentTarget.style.color = 'var(--pub-text-on-dark-secondary)';
                            }
                          }}
                        >
                          {t(link.i18nKey)}
        ...
        <div
          style={{
            height: 1,
            background: 'var(--pub-border-dark)',
          ...
          >
            <button
              ...
              style={{
                ...
                color:
                  currentLang === 'de'
                    ? 'var(--pub-text-on-dark)'
                    : 'var(--pub-text-on-dark-secondary)',
                padding: '4px 8px',
                fontFamily: 'var(--pub-font-body)',
                fontSize: 13,
              }}
